    ...
    public Void visit(DirectDeclarator directDeclarator) {
        if (directDeclarator.getIdentifier() != null) {
            ...
            if (this.tempo_add) {
                ...
                VarDecSymbolTableItem var_dec_item = new VarDecSymbolTableItem(id);
                try {
...
//        else if (expression.getExpressionType().equals("Function call")) {
//            if (expression.getArgumentExpressionList() == null) {
//                this.func_arg_count = 0;
////            } else if (expression.getArgumentExpressionList().getExpressions().size() == 1) {
////                    this.func_arg_count = 1;
//            } else {
//                this.func_arg_count = countArgsTree(expression.getArgumentExpressionList().getExpressions().get(0));
//            }
//
//            System.out.println(expression.getLine() + " " + expression.getExpressions().get(0).getIdentifier() + " " + func_arg_count);
////            System.out.println(expression.getArgumentExpressionList().getExpressions().get(0).getExpressionType());
//
//            expression.getExpressions().get(0).accept(this);
